...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
         ...
         String str[] = {"Manager", "Warden", "House Keeping", "Kitchen Staff", "Chef", "Security Guard"};
         ...
         ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Hostel/Management/System/icons/SIXTH.jpg"));
         Image i2 = i1.getImage().getScaledInstance(400,420, Image.SCALE_DEFAULT);
