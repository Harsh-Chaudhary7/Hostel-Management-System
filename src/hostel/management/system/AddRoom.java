...
public class AddRoom extends JFrame implements ActionListener{
    ...
    AddRoom() {
        ...
        type.setBounds(40,210,120,30);
        add(type);
        
        c2 = new JComboBox(new String[] {"Single","Double sharing","Triple sharing"});
        c2.setBounds(180,210,160,30);
        c2.setBackground(Color.white);
        add(c2);
        
        b1 = new JButton("Add");
        b1.setBounds(200,360,120,20);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hostel/management/system/icons/Eighth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b1) {
            ...
            try {
                String str = "insert into addroom values('"+room+"','"+available+"','"+type+"')";
